...
export const products: ProductData[] = [
  {
    ...
    dataPoints: [
      ...
      { label: "PDIC insured", value: "Yes" },
      { label: "Setup time", value: "~5 mins" },
    ],
    tags: ["No maintaining balance", "Instant transfers", "Kiosk signup"],
  ...
  },
  {
    ...
    tags: ["No maintaining balance", "Instant transfers", "App-only"],
  ...
  },
  {
    ...
    tags: ["Shopee cashback", "No maintaining balance", "App-only"],
  ...
  },
  {
    ...
    dataPoints: [
      ...
      { label: "Markets", value: "PSE Stocks" },
      { label: "Account types", value: "3" },
    ],
    tags: ["Free courses", "EIP available", "PSE direct"],
  ...
  },
  {
    ...
    dataPoints: [
      ...
      { label: "Markets", value: "US Stocks" },
      { label: "Fractional", value: "Yes" },
    ],
    tags: ["$1 minimum", "Zero commission", "Fractional shares"],
  ...
  },
  {
    ...
    dataPoints: [
      ...
      { label: "Unique feature", value: "Copy Trading" },
    ],
    tags: ["Copy trading", "Multi-asset", "Social feed"],
  ...
  },
  {
    ...
    dataPoints: [
      { label: "Credit limit", value: "Up to ₱30K" },
      { label: "Interest", value: "5%/month" },
      { label: "Requirement", value: "GCash acct" },
      { label: "Approval", value: "Instant" },
    ],
    tags: ["Builds credit score", "Instant approval", "In-app"],
